...
/**
 * Wordmark, inlined as SVG (not <Image>) so the letterforms follow the current
 * text colour via `fill-current`. The dot and swoosh of the "O" keep the
 * brand's blue accent (`fill-accent`) in both colour schemes, matching the
 * myown app's logo.
 */
export function Logo({ className }: { className?: string }) {
  return (
    ...
    >
      <svg aria-hidden viewBox="0 0 800 200" className="h-8 w-auto fill-current">
        ...
        <circle cx="421.28464" cy="38.30322" r="18.13609" className="fill-accent" />
        <path
